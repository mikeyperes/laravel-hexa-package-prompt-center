...
<div class="max-w-4xl mx-auto" x-data="promptForm()">
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 space-y-5">
        ...
        <div>
            ...
            <textarea x-model="form.body" class="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm font-mono" style="min-height: 400px; resize: vertical;" placeholder="Enter your prompt here..."></textarea>
        </div>
